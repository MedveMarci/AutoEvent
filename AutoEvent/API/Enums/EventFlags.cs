...
public enum EventFlags
{
    ...
    IgnoreAll = IgnoreRespawnTeam | IgnoreDecontaminating | IgnoreBulletHole | IgnoreRagdoll | IgnoreInfiniteAmmo |
                IgnoreDroppingAmmo | IgnoreDroppingItem | IgnoreHandcuffing
}